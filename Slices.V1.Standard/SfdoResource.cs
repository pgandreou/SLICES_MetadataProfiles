...
public sealed class SfdoResource
{
    ...
    [SlicesAccessModifer(SlicesAccessModiferType.PU)]
    public List<SfdoIdentifier> AlternateIdentifiers { get; } = new();
    ...
    public List<SfdoCreator> Creators { get; } = new();
    ...
    [SlicesParticipation(SlicesParticipationType.RequiredIfExists)]
    [SlicesAccessModifer(SlicesAccessModiferType.PR)]
    public List<SfdoContributor> Contributors { get; } = new();
    ...
    [SlicesParticipation(SlicesParticipationType.Required)]
    [SlicesAccessModifer(SlicesAccessModiferType.PU)]
    public List<SfdoAccessType> AccessTypes { get; } = new();
    ...
    [SlicesParticipation(SlicesParticipationType.Required)]
    [SlicesAccessModifer(SlicesAccessModiferType.PU)]
    public List<SfdoAccessMode> AccessModes { get; } = new();
    ...
    [SlicesParticipation(SlicesParticipationType.Optional)]
    [SlicesAccessModifer(SlicesAccessModiferType.PU)]
    public List<SfdoRelationLink> RequiredObjects { get; } = new();
    ...
    [SlicesParticipation(SlicesParticipationType.Optional)]
    [SlicesAccessModifer(SlicesAccessModiferType.PU)]
    public List<SfdoRelationLink> RelatedObjects { get; } = new();
    ...
    [SlicesParticipation(SlicesParticipationType.Optional)]
    [SlicesAccessModifer(SlicesAccessModiferType.PU)]
    public List<LanguageIso639_3> PrimaryLanguage { get; } = new();
    ...
    [SlicesParticipation(SlicesParticipationType.Optional)]
    [SlicesAccessModifer(SlicesAccessModiferType.PU)]
    public List<LanguageIso639_3> OtherLanguages { get; } = new();
